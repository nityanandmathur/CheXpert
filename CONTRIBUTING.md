...
Welcome to `chexpert` contributor's guide.
...
If you experience bugs or general issues with `chexpert`, please have a look
...
You can help improve `chexpert` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`chexpert` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `chexpert`'s files. While this mechanism can
...
```
conda create -n chexpert python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/chexpert.git
   cd chexpert
   ```
...
5. Install [pre-commit]:
   ...
   `chexpert` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/chexpert
[issue tracker]: https://github.com/<USERNAME>/chexpert/issues
